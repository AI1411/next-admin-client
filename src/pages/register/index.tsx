...
const Register = () => {
    return (
        <div
            ...
            <span
                className="border text-4xl text-yellow-800 px-6 pt-10 pb-8 bg-white w-1/2 max-w-md mx-auto rounded-t-md sm:px-10">新規登録</span>
            <div
                className="border relative px-4 pt-7 pb-8 bg-white shadow-xl w-1/2 max-w-md mx-auto sm:px-10 rounded-b-md">
                <form action="">
                    <label htmlFor="" className="block">姓</label>
                    <input type="Email" className="border w-full h-10 px-3 mb-5 rounded-md"
                           placeholder="Username or Email"/>
                    <label htmlFor="" className="block">名</label>
                    <input type="Email" className="border w-full h-10 px-3 mb-5 rounded-md"
                           placeholder="Username or Email"/>
                    <label htmlFor="" className="block">メールアドレス</label>
                    <input type="Email" className="border w-full h-10 px-3 mb-5 rounded-md"
                           placeholder="Username or Email"/>
                    <label htmlFor="" className="block">年齢</label>
                    <input type="Email" className="border w-full h-10 px-3 mb-5 rounded-md"
                           placeholder="Username or Email"/>
                    <label htmlFor="" className="block">パスワード</label>
                    <input type="password" className="border w-full h-10 px-3 mb-5 rounded-md"
                           placeholder="password"/>
                    <label htmlFor="" className="block">パスワード確認</label>
                    <input type="password" className="border w-full h-10 px-3 mb-5 rounded-md"
                           placeholder="password"/>
