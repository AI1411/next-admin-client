          ...
          <main>
            <div
              ...
              <div className="mb-1 w-full">
                <div className="mb-4">
                 <nav className="fslex mb-5" aria-label="Breadcrumb">
                  ...
                  <h1 className="text-xl sm:text-2xl font-semibold text-gray-900">All coupons</h1>
                </div>
                    ...
                    <table className="table-fixed min-w-full divide-y divide-gray-200">
                      ...
                      {data.length !== 0 ? (
                        data.map((coupon: Coupon) =>
                          <CouponTableRow handleDelete={deleteCoupon} coupon={coupon} key={coupon.id}/>
                        )
                      ) : (
                        <div className="hover:bg-gray-100 justify-center">
                          <p className={`my-3 mx-4`}>クーポンはありません</p>
                        </div>
                      )}
                      </tbody>
                    </table>
