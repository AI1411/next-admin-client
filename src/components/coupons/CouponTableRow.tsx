...
const CouponTableRow = ({coupon, handleDelete}: any) => {
  return (
    <tr className="hover:bg-gray-100" key={coupon.id}>
      ...
      <td className="p-4 whitespace-nowrap text-base font-normal text-gray-900">
        <Date
          dateString={coupon.use_start_at}
        />
      </td>
      <td className="p-4 whitespace-nowrap text-base font-medium text-gray-900">
        <Date
          dateString={coupon.use_end_at}
        />
      </td>
      <td className="p-4 whitespace-nowrap text-base font-medium text-gray-900">
        <Date
          dateString={coupon.public_start_at}
        />
      </td>
      <td className="p-4 whitespace-nowrap text-base font-normal text-gray-900">
        <Date
          dateString={coupon.public_end_at}
        />
      </td>
      <td className="p-4 whitespace-nowrap text-base font-normal text-gray-900">
        {coupon.is_public}
